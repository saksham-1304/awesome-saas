...
| [**Coden-inja/alchEmaiLyst**](https://github.com/Coden-inja/alchEmaiLyst) | 6 | A three agent system for leveraging AI to summarise, compose, send emails. Also stay away from spam |  email,  marketing |
